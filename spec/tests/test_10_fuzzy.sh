...
output=$(lab_run --path="$TEST_LABS" --and-keys="BETA"$'\r' exec 2>/dev/null)
...
output=$(lab_run --path="$TEST_LABS" --and-keys="AlPhA"$'\r' exec 2>/dev/null)
...
output=$(lab_run --path="$TEST_LABS" --and-keys="gam"$'\r' exec 2>/dev/null)
...
output=$(lab_run --path="$TEST_LABS" --and-keys="xyznotfound"$'\r' exec 2>/dev/null)
