...
output=$(lab_run --path="$TEST_LABS" --and-exit --and-keys="abc,BACKSPACE" exec 2>&1)
...
output=$(lab_run --path="$TEST_LABS" --and-exit --and-keys="ab,BACKSPACE,BACKSPACE" exec 2>&1)
...
output=$(lab_run --path="$TEST_LABS" --and-exit --and-keys="abc,LEFT,LEFT,d" exec 2>&1)
...
output=$(lab_run --path="$TEST_LABS" --and-exit --and-keys="a b" exec 2>&1)
...
output=$(lab_run --path="$TEST_LABS" --and-exit --and-keys="alpha-test" exec 2>&1)
...
output=$(lab_run --path="$TEST_LABS" --and-exit --and-keys="$LONG_INPUT" exec 2>&1)
...
output=$(lab_run --path="$TEST_LABS" --and-exit --and-keys="testing,CTRL-U" exec 2>&1)
...
output=$(lab_run --path="$TEST_LABS" --and-exit --and-keys="xyznonexistent" exec 2>&1)
stripped=$(echo "$output" | strip_ansi)
